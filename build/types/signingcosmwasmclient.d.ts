...
export declare class SigningCosmWasmClient extends CosmWasmClient {
     ...
     */
    constructor(apiUrl: string, senderAddress: string, signer: SigningCallback | OfflineSigner, seed?: Uint8Array, customFees?: Partial<FeeTable>, broadcastMode?: BroadcastMode);
    ...
    instantiate(codeId: number, initMsg: object, label: string, memo?: string, transferAmount?: readonly Coin[]): Promise<InstantiateResult>;
    execute(contractAddress: string, handleMsg: object, memo?: string, transferAmount?: readonly Coin[]): Promise<ExecuteResult>;
